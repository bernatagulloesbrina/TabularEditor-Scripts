...

{
    ...
    public partial class VisualDto
    {
        ...
        public class QueryState
        {
            ...
            [JsonProperty("Y", Order = 2)] public VisualDto.ProjectionsSet Y { get; set; }
            [JsonProperty("Y2", Order = 3)] public VisualDto.ProjectionsSet Y2 { get; set; }
            [JsonProperty("Values", Order = 4)] public VisualDto.ProjectionsSet Values { get; set; }
            [JsonProperty("Category", Order = 5)] public VisualDto.ProjectionsSet Category { get; set; }
